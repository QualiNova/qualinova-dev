...
describe('KeyFeatures', () => {
    describe('Default Rendering', () => {
        ...
        it('renders default feature descriptions', () => {
            ...
            expect(
                screen.getByText('Verify certificates instantly using ID or QR code scanning'),
            ).toBeInTheDocument();
            expect(
                screen.getByText('Manage all your certifications in one centralized dashboard'),
            ).toBeInTheDocument();
        });
