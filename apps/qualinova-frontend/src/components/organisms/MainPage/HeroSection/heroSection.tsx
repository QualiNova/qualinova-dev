                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8 lg:gap-16">
                    ...
                    <div className="w-full md:w-1/2 space-y-6" data-testid="left-section-container">
                        ...
                        <p className="text-gray-300 font-light text-2xl leading-10 md:pr-8">
                            QualiNova provides tamper-proof certification management powered by
                            Stellar blockchain technology. Create, verify, and manage certifications
                            with confidence
                        </p>
                    ...
                    <div
                        ...
                        data-testid="right-section-container"
                    >
                        <div
                            className="bg-gray-800 rounded-lg w-full md:h-[600px] h-[400px] flex items-center justify-center"
                            data-testid="certificate-placeholder-container"
                        >
