...
describe("HowItWorks", () => {
  ...
  describe("Get Started Section", () => {
    ...
    it("renders both action buttons", () => {
      expect(
        screen.getByText("Create Your First Certificate"),
      ).toBeInTheDocument();
  ...
  describe("Styling and Layout", () => {
    ...
    it("has responsive grid layout for process steps", () => {
      ...
      expect(stepsContainer).toHaveClass(
        "grid",
        "grid-cols-1",
        "md:grid-cols-3",
        "gap-8",
...
describe("HowItWorks Integration", () => {
  ...
  it("maintains consistent styling across sections", () => {
    ...
    expect(howItWorksHeading).toHaveClass(
      "text-white",
      "text-3xl",
      "font-bold",
    );
    expect(getStartedHeading).toHaveClass(
      "text-white",
      "text-3xl",
      "font-bold",
    );
