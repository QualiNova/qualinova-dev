    ...
    <form className="w-full max-w-[832px] min-w-[320px] border border-[#27272A] rounded-lg flex flex-col items-start px-[1px] py-6 shadow-sm">
      <div className="w-full px-7">
        <div className="w-full flex items-center justify-between gap-5">
          <h3 className="text-[#FAFAFA] font-semibold text-2xl">
            Certificate Details
          </h3>
      ...
      <div className="border border-[#27272A] rounded-lg flex items-start text-[#A1A1AA] gap-2 w-full py-4 px-7 mt-7">
        ...
        <div className="space-y-1">
          ...
          <p>
            Once a certificate is registered on the blockchain, its core details
            cannot be modified
          </p>
        </div>
      </div>
      ...
      <div className="text-[#FAFAFA] border border-[#27272A] rounded-lg w-full flex flex-col gap-4 mt-7 py-4 px-7">
        ...
        <div className="flex w-full">
          ...
          <p className="w-[50%]">{data.type}</p>
        </div>
        <div className="flex w-full">
          <h4 className="w-[50%]">Recipient</h4>
          <p className="w-[50%]">{data.recipientName}</p>
        </div>
        <div className="flex w-full">
          <h4 className="w-[50%]">Issue Date</h4>
          <p className="w-[50%]">{data.issueDate}</p>
        </div>
        <div className="flex w-full">
          <h4 className="w-[50%]">Expiry Date</h4>
          <p className="w-[50%]">{data.expiryDate}</p>
        </div>
        <div className="flex w-full">
      ...
      <div className="w-full flex items-center justify-between gap-5 p-6">
        <button
          type="button"
          className="bg-[#09090B] border border-[#27272A] text-[#FAFAFA] rounded-md py-[9.5px] px-[17px] text-sm font-medium cursor-pointer transform hover:scale-95 duration-200"
        ...
        <button
          type="button"
          className="bg-[#2563EB] text-[#18181B] rounded-md py-[9.5px] px-[17px] text-sm font-medium cursor-pointer transform hover:scale-95 duration-200"
        >
          Create Certificate
        </button>
      </div>
