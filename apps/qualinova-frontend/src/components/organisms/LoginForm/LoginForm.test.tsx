...
describe("LoginForm Component", () => {
  ...
  describe("Links and Navigation", () => {
    ...
    it("displays sign up link", () => {
      ...
      expect(screen.getByTestId("link-register")).toHaveAttribute(
        "href",
        "/register",
      );
    });
  ...
  describe("Styling and Layout", () => {
    ...
    it("password field has correct label styling", () => {
      ...
      expect(passwordLabel).toHaveClass(
        "block",
        "text-sm",
        "font-medium",
        "text-white",
    ...
    it("has responsive divider layout", () => {
      render(<LoginForm />);
      const dividerContainer = screen
        .getByText("OR CONTINUE WITH")
        .closest(".flex");
    ...
    it("form fields have proper spacing", () => {
      ...
      const emailContainer = screen
        ...
        .closest(".space-y-1\\.5");
      const passwordContainer = screen
